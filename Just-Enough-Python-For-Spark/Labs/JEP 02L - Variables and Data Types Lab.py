...
assert type(conversion_rate) == float, f"Conversion rate was expected as float, but it was found as {type(conversion_rate)}"
...
# TODO
print(f"{euro_amount} Euris is equal to ${usd_amount} USD")
